        ...
        <div class="user-menu-wrapper">
            ...
            <div id="dropdown-menu" class="dropdown-content">
                <?php if(isset($_SESSION['user_id'])) { ?>
                    <p style="padding:10px; color:green; text-align:center; margin:0; font-weight:bold;">
                ...
                <a href="../main_page/main_page.php" class="home">Home</a>
                <a href="../about/about_us.php" class="about">About</a>
